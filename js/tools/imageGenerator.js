...
export function initImageGenerator() {
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        resultContainer.innerHTML = '<div class="spinner-container"><i class="ph-bold ph-spinner ph-spin"></i> AI đang vẽ, vui lòng chờ...</div>';
...
async function generateImageWithAI(prompt) {
    ...
    if (!apiKey) {
        throw new Error("VITE_AI_API_KEY chưa được thiết lập trong file .env hoặc server chưa được khởi động lại.");
    }
